...
def getURL(url, tries_num=5, sleep_time=0, time_out=10, max_retry=5, isproxy=False):
    """
...
class FundSpiders():
    ...
    def getFundInfo(self, fund_code):
        ...
        try:
            print (
            self.getCurrentTime(), 'getFundInfo:', result['fund_code'], result['fund_name'], result['fund_abbr_name'],
